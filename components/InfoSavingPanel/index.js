...
const InfoSavingPanel = ({ goToForm, setGoToForm, setSelectedMethod }) => {
  ...
  const {
    isOpenModal: isOpenModalSolar,
    openModal: openModalSolar,
    closeModal: closeModalSolar } = useModal(false)

  const {
    isOpenModal: isOpenModalSupportSystem,
    openModal: openModalSupportSystem,
    closeModal: closeModalSupportSystem } = useModal(false)

  const {
    isOpenModal: isOpenModalSolarAndSupport,
    openModal: openModalSolarAndSupport,
    closeModal: closeModalSolarAndSupport } = useModal(false)


  return (
    <article className={`transition ${goToForm && "-translate-x-full hidden"} font-[Poppins]`}>
      ...
      {isOpenModalSolar &&
        <ModalInformation
          ...
          savingMethod={METHODS_OF_SAVING.SOLAR}
      ...
      {
        isOpenModalSupportSystem &&
        <ModalInformation
          closeModal={closeModalSupportSystem}
          setGoToForm={setGoToForm}
          savingMethod={METHODS_OF_SAVING.SYSTEM_SUPPORT}
          setSelectedMethod={setSelectedMethod}
        >
      ...
      {
        isOpenModalSolarAndSupport &&
        <ModalInformation
          closeModal={closeModalSolarAndSupport}
          setGoToForm={setGoToForm}
          savingMethod={METHODS_OF_SAVING.SUPPORT_SOLAR}
          setSelectedMethod={setSelectedMethod}
        >
      ...
      <section className="flex flex-wrap justify-center items-center pt-2">
        ...
        />
        <InformationCard
          typeOfSaving={METHODS_OF_SAVING.SYSTEM_SUPPORT}
          urlImage={Respaldo}
          setGoToForm={setGoToForm}
          openModal={openModalSupportSystem}
          setSelectedMethod={setSelectedMethod}
        />
        <InformationCard
          typeOfSaving={METHODS_OF_SAVING.SUPPORT_SOLAR}
          urlImage={Hibrido}
          setGoToForm={setGoToForm}
          openModal={openModalSolarAndSupport}
          setSelectedMethod={setSelectedMethod}
