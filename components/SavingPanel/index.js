...
const SavingPanel = ({goToForm, setGoToForm, selectedMethod}) => {
    ...
    return (
        <article className={
            `transition ${
                goToForm ? "block translate-x-0" : "translate-x-full hidden"
            } font-[Poppins] my-4`
        }>
            ...
            <p className='mt-4'>
                {"Por favor ayúdanos con algunos datos para poder identificar nuestra mejor solución para tí"}</p>
            ...
            <div className="w-full">
                <p> {"Si quieres escoger otro método de ahorro, haz clic "}
